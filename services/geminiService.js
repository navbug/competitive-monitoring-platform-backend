...
//         .map((u) => `${u.competitor.name}: ${u.title}`)
//         .join("\n");

//       const prompt = `Analyze these competitor updates for patterns and trends.
...
//         .map((u) => `- ${u.classification.category}: ${u.title}`)
//         .join("\n");

//       const prompt = `Generate competitive insights for this competitor.
...
//   "strategicFocus": "what they're focusing on",
